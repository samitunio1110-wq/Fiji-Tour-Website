...
const Footer = () => {
  ...
  />
          ...
          {/* SOCIAL */}
          <div className="flex gap-6 mt-6 text-[#12c0e2] text-4xl">
        ...
        <div>
          ...
          />
          <button className="mt-4 w-full bg-[#12c0e2] hover:bg-white hover:text-black transition-all py-2 rounded-md text-sm font-medium hover:border hover:border-[#12c0e2]">
            Subscribe
          </button>
        </div>
